...
export default function Page() {
    ...
    return (
        <div className="w-screen min-h-screen bg-gray-200 pb-10">
            ...
            <div className="lg:w-[95vw] w-full pt-40 mx-auto lg:flex justify-start border-b-[0.5px] hidden border-zinc-200 pb-2 mb-5 gap-5 items-center">
                <Breadcrumb>
                    <BreadcrumbList>
            ...
            <div className="w-full lg:w-[95vw] mx-auto bg-white rounded-b-3xl">
                <Pagination>
